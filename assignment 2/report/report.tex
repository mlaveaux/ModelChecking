...
First we will show the evaluation of the algorithm on the created parity games. Afterwards the algorithm will be evaluated on the dining test cases and lastly on the the elevator test cases.
...
In this section the algorithm is evaluated on the dining philosophers test case set.
