...
In the evaluation the blue line represents the input order, red represents the random order, purple represents the indegree order and black represents the breadth first order.
