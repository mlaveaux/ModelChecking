...
First we will show the evaluation of our self-made parity games. Afterwards the dining test cases will be evaluated and lastly the elevator test cases will be evaluated.\\

\subsection{Self-made parity games}

See figure \ref{paritygames} for the self-made parity games. A box represents a vertex owned by the odd player, a diamond represents a vertex owned by the even player. The integer value inside a vertex represents its priority, the integer value next to the vertex is its identifier.\\
...
\caption{The self made parity games}
\label{paritygames}
\end{figure}
